        ...
        <el-container>
            ...
            <div class="search-content">
                <div class="search-box">
                    <el-autocomplete v-model="station_value1" :fetch-suggestions="querySearchAsync"
                                     placeholder="输入拼音首字母或汉字"
                                     @select="stationSelect1">
                        <template slot="prepend">起点站</template>
                    </el-autocomplete>
                    <el-autocomplete v-model="station_value2" :fetch-suggestions="querySearchAsync"
                                     placeholder="输入拼音首字母或汉字"
...
<script>
  ...
  export default {
    ...
    methods: {
      gologin() {
        this.$router.push({path: '/trainLogin'})
      },
